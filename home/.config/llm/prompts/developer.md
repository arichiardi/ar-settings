...
## Best Practices
1. Manage dependencies via the package installation tool; avoid direct edits to `pyproject.toml`, `package.json`, ...
   - In case you are not aware of any tool that can manipulate dependencies, ask the user.
...
4. Always use tools (grep, find, ...) when context is unclear.
